...
// =================================================================================
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glClearColor(0.2f, 0.2f, 0.2f, 1.0f);  // Aumentado de 0.1f para un fondo m�s claro
  ...
  //      view = camera.GetViewMatrix();	
	...
	/*	PinguinoCuerpo = glm::translate(PinguinoCuerpo, glm::vec3(28.0f, -0.2f, -20.5f));
		...
		cuboDraw(model, glm::vec3(0.2f, 0.2f, 0.05f),glm::vec3(1.0f, 1.45f, 1.925f),modelLoc, VAO_Cubo, amarilloTextureID, 0.0f);// P�talo Trasero (-Z)
		cuboDraw(model, glm::vec3(0.05f, 0.2f, 0.2f),glm::vec3(1.075f, 1.45f, 2.0f),modelLoc, VAO_Cubo, amarilloTextureID, 0.0f);// P�talo Derecho (+X)
		cuboDraw(model, glm::vec3(0.05f, 0.2f, 0.2f),glm::vec3(0.925f, 1.45f, 2.0f),modelLoc, VAO_Cubo, amarilloTextureID, 0.0f);// P�talo Izquierdo (-X)
